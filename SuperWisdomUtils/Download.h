...
public:
	...
	static bool download(const TCHAR *url, const TCHAR*  filedir, const TCHAR* filename, bool reload = false, void(*update)(unsigned long, unsigned long) = NULL);
